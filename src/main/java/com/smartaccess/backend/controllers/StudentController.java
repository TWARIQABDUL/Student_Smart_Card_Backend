...
import com.smartaccess.backend.dto.UserDto;
import com.smartaccess.backend.models.User;
import com.smartaccess.backend.service.UserServices;
...
public class StudentController {
    ...
    @Autowired
    private UserServices studentService;
    ...
    //     );
    // }
    private UserDto mapToDto(User student) {
    ...
    public ResponseEntity<?> getAllStudents(@AuthenticationPrincipal UserDetails userDetails) {
        try {
            User requester = getAuthenticatedStudent(userDetails);
            List<User> students = studentService.getAllStudents(requester);
    ...
    public ResponseEntity<?> getStudentById(
        ...
        try {
            User requester = getAuthenticatedStudent(userDetails);
            User target = studentService.getStudentById(requester, id);
    ...
    public ResponseEntity<?> createStudent(
        ...
        try {
            User requester = getAuthenticatedStudent(userDetails);
            User createdStudent = studentService.createStudent(requester, request);
    ...
    public ResponseEntity<?> updateStudent(
        ...
        try {
            User requester = getAuthenticatedStudent(userDetails);
            User updatedStudent = studentService.updateStudent(requester, id, request);
