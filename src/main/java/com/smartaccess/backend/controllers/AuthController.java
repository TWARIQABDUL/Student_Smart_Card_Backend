...
import com.smartaccess.backend.dto.FirstLoginChangePasswordDto; 
import com.smartaccess.backend.dto.LoginRequestDto;
import com.smartaccess.backend.dto.LoginResponseDto;
...
import com.smartaccess.backend.service.JwtService;
...
public class AuthController {
    ...
    private UserDto mapToUserDto(User student) {
    ...
    public ResponseEntity<?> loginUser(@RequestBody LoginRequestDto loginDto) {
        try {
            ...
            User student = studentService.authenticate(loginDto.getEmail(), loginDto.getPassword());
    ...
    public ResponseEntity<?> changeFirstPassword(@RequestBody FirstLoginChangePasswordDto request) {
        try {
            ...
            User updatedStudent = studentService.changePassword(
                request.getEmail(), 
