...
import com.smartaccess.backend.dto.GateVerifyRequestDto;
import com.smartaccess.backend.dto.Roles;
import com.smartaccess.backend.dto.Status;
...
public class GateService {
    ...
    // =========================================================================
    public Map<String, Object> verifyEntry(User guard, GateVerifyRequestDto request) {
        ...
        if (studentOpt.isEmpty() && token.contains(":")) {
            try {
                ...
                if (parts.length == 3) {
                    ...
                    Optional<User> candidate = studentRepository.findById(id);
    ...
    // =========================================================================
    public List<Map<String, Object>> getAccessHistory(User requester, LocalDateTime start, LocalDateTime end, int limit) {
        ...
        if (requester.getRole() == Roles.SUPER_ADMIN) {
            ...
            Organization c = requester.getCampus();
